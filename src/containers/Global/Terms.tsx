  ...
  return (
    <div className={className}>
      <div className="content">
        ...
        <p>
          Welcome to&nbsp;<strong>UpStamps</strong>&nbsp;(&ldquo;
          <strong>Company</strong>&rdquo;, &ldquo;<strong>we</strong>&rdquo;,
          &ldquo;<strong>our</strong>&rdquo;, &ldquo;<strong>us</strong>
        ...
        <p>
          ...
          Service (&ldquo;<strong>Purchase</strong>&rdquo;), you may be asked to
        ...
        <p>
          Some parts of Service are billed on a subscription basis (&ldquo;
          <strong>Subscription(s)</strong>&rdquo;). You will be billed in
          advance on a recurring and periodic basis (&ldquo;
          <strong>Billing Cycle</strong>&rdquo;). Billing cycles are
        ...
        <p>
          ...
          payment information, you automatically authorize&nbsp;UpStamps&nbsp;to
          charge all Subscription fees incurred through your account to any such
          payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any
          reason,&nbsp;UpStamps&nbsp;will issue an electronic invoice indicating
          that you must proceed manually, within a certain deadline date, with
          the full payment corresponding to the billing period as indicated on
          the invoice.
        </p>
        <ol start={5}>
          <li>
        ...
        <p>
          UpStamps&nbsp;may, at its sole discretion, offer a Subscription with a
          free trial for a limited period of time (&ldquo;
          <strong>Free Trial</strong>&rdquo;).
        </p>
        <p>
        ...
        <p>
          ...
          Trial, you will not be charged by&nbsp;UpStamps&nbsp;until Free Trial
        ...
        <p>
          At any time and without notice,&nbsp;UpStamps&nbsp;reserves the right
        ...
        <p>
          UpStamps, in its sole discretion and at any time, may modify
        ...
        <p>
          UpStamps&nbsp;will provide you with a reasonable prior notice of any
        ...
        <p>
          ...
          material (&ldquo;<strong>Content</strong>&rdquo;). You are responsible
        ...
        <p>
          UpStamps&nbsp;has the right but not the obligation to monitor and edit
          all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of&nbsp;UpStamps&nbsp;or used with permission. You may not distribute,
        ...
        <p>
          ...
          property of&nbsp;UpStamps&nbsp;and its licensors. Service is protected
          ...
          product or service without the prior written consent of&nbsp;UpStamps.
        </p>
        <ol start={14}>
          <li>
            <strong>
        ...
        <p>
          ...
          (&ldquo;<strong>Infringement</strong>&rdquo;) of any person or entity.
        </p>
        <p>
        ...
        <p>
          ...
          that are not owned or controlled by&nbsp;UpStamps
        </p>
        <p>
          UpStamps&nbsp;has no control over, and assumes no responsibility for
          the content, privacy policies, or practices of any third party web
          sites or services. We do not warrant the offerings of any of these
          entities/individuals or their websites.
        </p>
        <p>
          YOU ACKNOWLEDGE AND AGREE THAT&nbsp;UpStamps&nbsp;SHALL NOT BE
        ...
        <p>
          ...
          laws of&nbsp;State of California&nbsp;without regard to its conflict
          of law provisions.
        </p>
        <p>
